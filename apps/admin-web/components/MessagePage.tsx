...
// Same intentionally-unstyled shell as guest-web's and staff-pwa's — full
// DHOP branding (Satoshi/Inter) lands once there's more than a couple of
// screens to design against.
